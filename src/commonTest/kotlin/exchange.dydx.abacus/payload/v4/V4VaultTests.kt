...
class V4VaultTests : V4BaseTests() {
    ...
    private fun testMegaVaultPnlReceived() {
        perp.rest(
            url = AbUrl.fromString("$testRestUrl/vault/v1/megavault/historicalPnl"),
    ...
    private fun testVaultMarketPnlsReceived() {
        perp.rest(
            url = AbUrl.fromString("$testRestUrl/vault/v1/vaults/historicalPnl"),
    ...
    private fun testVaultMarketPositionsReceived() {
        perp.rest(
            url = AbUrl.fromString("$testRestUrl/vault/v1/megavault/positions"),
