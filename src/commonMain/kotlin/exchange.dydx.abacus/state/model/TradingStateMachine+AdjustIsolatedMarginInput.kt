            ...
            if (validAdjustIsolatedMarginInput(
                ...
                when (type) {
                    ...
                    AdjustIsolatedMarginInputField.Amount -> {
                        val isolatedMarginAdjustmentType =
                            adjustIsolatedMargin["Type"] ?: IsolatedMarginAdjustmentType.Add.name
                        val subaccountNumber =
                            if (isolatedMarginAdjustmentType == IsolatedMarginAdjustmentType.Add.name) {
                                parentSubaccountNumber
                            } else {
                                childSubaccountNumber
                            }
                        ...
                        val freeCollateral =
                            parser.asDouble(parser.value(subaccount, "freeCollateral.current"))
