...
internal class InputValidator(
    ...
    private val errorTypeLookup =
            mapOf<String, Int>(
                    "ERROR" to 0,
                    "REQUIRED" to 1,
                    "WARNING" to 2,
            )
    private val errorCodeLookup =
            mapOf<String, Int>(
    ...
    private val tradeValidators =
            listOf<ValidatorProtocol>(
    ...
    private val closePositionValidators =
            listOf<ValidatorProtocol>(
                    AccountInputValidator(localizer, formatter, parser),
                    FieldsInputValidator(localizer, formatter, parser),
                    TradeInputValidator(localizer, formatter, parser),
    ...
    private val transferValidators =
            listOf<ValidatorProtocol>(
                    FieldsInputValidator(localizer, formatter, parser),
